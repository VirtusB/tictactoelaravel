...
<script language="JavaScript">
    ...
    var pusher = new Pusher('6fb6333b4da84b5d2e05', { cluster: 'eu' });
    ...
    $(document).ready(function(){
        $('input[type=radio]').on('click', function(){
            ...
            if(!result){
                $('.profile-username').html('Waiting on opponent');
                $.ajax({
        ...
        <div class="col-md-12">
            <div class="profile-info">
                <div class="profile-username">
                    {{ $user->id == $nextTurn->player_id ? "Your are next!" : "Waiting for opponent" }}
                </div>
            </div>
        </div>
    </div>
